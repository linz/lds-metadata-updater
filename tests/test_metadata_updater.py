...
sys.path.append("../")
from metadata_updater import log, metadata_updater
...
class TestMetadataUpdaterConfig(unittest.TestCase):
    ...
    def test_read_config(self):
        ...
        self.assertEqual(
            config.text_mapping,
            {
                1: {"search": "the terrace", "replace": "The Road", "ignore_case": True},
                2: {"search": "Land Info New Zealand", "replace": "Land Information Aoteroa", "ignore_case": True},
            },
        )
