...
input_metadata_dir = (
    "C:/Users/ECheng/OneDrive - Land Information New Zealand/Desktop/Repo/Output"
)
files = [
    os.path.join(input_metadata_dir, f)
    for f in os.listdir(input_metadata_dir)
    if f.endswith(".iso.xml")
]  # get a list of all .iso files in the Output directory
